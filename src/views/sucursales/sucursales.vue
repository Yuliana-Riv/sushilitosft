...
import AddU from './addSucursales.vue'
import EditU from './editSucursales.vue'
export default {
  name: 'Usuarios',
  components:{
   AddU,
 ...
 active:false,
  ...
  created() {
     this.getAllInfoSuc('sucursales')
  },
  
  computed:{
     data() {
          let data = this.$store.getters["sucursales/data"];
       ...
       ...mapActions('sucursales', ['getAllInfoSuc']),
         ...
         includesItem(search, name){
          ...
          return name.includes(search)
           ...
           changeView(option, item){
             ...
             this.setHistoryOptionSuc(option)
         },
        ...
        eliminar: async function(){
            ...
            this.message='';
             ...
             let result = await this.$store.dispatch("sucursales/deleteItemSuc", {option: 'sucursales', id:id});
