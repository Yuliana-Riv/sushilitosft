<template>
  <div id="AddSM">
    <div class="form-content">
      <form @submit.prevent="submit(social_media, link)"> 
        <div class="grup-form dflx">
          <div class="boxform">
            ...
            <div class="dflx">
              <div
                class="selop"
                :class="{ active: social_media == 'FACEBOOK' }"
                @click="social_media = 'FACEBOOK'"
              >
                FACEBOOK
              </div>
              <div
                class="selop"
                :class="{ active: social_media == 'TWITTER' }"
                @click="social_media = 'TWITTER'"
              >
              TWITTER
              </div>
              <div
                class="selop"
                :class="{ active: social_media == 'INSTAGRAM' }"
                @click="social_media = 'INSTAGRAM'"
              >
              INSTAGRAM
              </div>
              <div
                class="selop"
                :class="{ active: social_media == 'TIKTOK' }"
                @click="social_media = 'TIKTOK'"
              >
              TIKTOK
              </div>
              <div
                class="selop"
                :class="{ active: social_media == 'YOUTUBE' }"
                @click="social_media = 'YOUTUBE'"
              >
              YOUTUBE
              </div>
              <div
                class="selop"
                :class="{ active: social_media == 'LINKEDIN' }"
                @click="social_media = 'LINKEDIN'"
              >
              LINKEDIN
              </div>
            </div>
...
export default {
  ...
  methods: {
    ...
    submit: async function (social_media,link) {
      this.status = "";
      this.message = ""; 
      let result = await this.$store.dispatch("social_media/addItemSM", {
        option: "social_media",
        item: {
          social_media, 
          link, 
