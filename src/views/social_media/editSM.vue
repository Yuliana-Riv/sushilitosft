<template>
  <div id="AddSM">
    <div class="form-content">
      <form @submit.prevent="submit(added.social_media, added.link)"> 
        <div class="grup-form dflx">
          <div class="boxform">
            <label for="titulo" class="titulo">Red social </label>
            <div class="dflx">
              <div
                class="selop"
                :class="{ active: added.social_media == 'FACEBOOK' }"
                @click="added.social_media = 'FACEBOOK'"
              >
                FACEBOOK
              </div>
              <div
                class="selop"
                :class="{ active: added.social_media == 'TWITTER' }"
                @click="added.social_media = 'TWITTER'"
              >
              TWITTER
              </div>
              <div
                class="selop"
                :class="{ active: added.social_media == 'INSTAGRAM' }"
                @click="added.social_media = 'INSTAGRAM'"
              >
              INSTAGRAM
              </div>
              <div
                class="selop"
                :class="{ active: added.social_media == 'TIKTOK' }"
                @click="added.social_media = 'TIKTOK'"
              >
              TIKTOK
              </div>
              <div
                class="selop"
                :class="{ active: added.social_media == 'YOUTUBE' }"
                @click="added.social_media = 'YOUTUBE'"
              >
              YOUTUBE
              </div>
              <div
                class="selop"
                :class="{ active: added.social_media == 'LINKEDIN' }"
                @click="added.social_media = 'LINKEDIN'"
              >
              LINKEDIN
              </div>
            </div>
...
export default {
  ...
  computed: {
    added() {
      return this.$store.getters["social_media/getAdded"];
    },
    identity() {
  ...
  methods: {
    ...
    submit: async function (social_media,link) {
      this.status = "";
      this.message = ""; 
      let result = await this.$store.dispatch("social_media/editItemSM", {
        option: "social_media",
        item: {
          id: this.added.id,
          social_media, 
