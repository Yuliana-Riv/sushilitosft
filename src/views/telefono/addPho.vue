<template>
  <div id="AddPho">
    <div class="form-content">
      <form @submit.prevent="submit(phone, type, link)">
        ...
        <div class="grup-form dflx" v-if="type == 'WHATSAPP'">
          <div class="boxform">
...
export default {
  ...
  methods: {
    ...
    submit: async function (phone, type, link) {
      ...
      let result = await this.$store.dispatch("phone/addItemPho", {
        option: "phone",
        item: {
          phone,
          type,
