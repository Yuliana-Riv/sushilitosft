                ...
                <div  v-if="data.length>0">
                    <div class="tbl_items dflx" v-for="(item, key) in filteredItems" :key="key">
                        ...
                        <div class="tbl_item ">
                            ...
                            <div class="icon_editar" v-if="identity.sub == item.id_colaborador">
                                <img   @click="changeView('Edit',item)" src="../../assets/default/i_editar.png" alt="icono editar"   >
                            </div>
                            <div class="icon_eliminar" v-if="identity.sub == item.id_colaborador">
...
import AddClb from './addClb.vue'
import EditClb from './editClb.vue'
export default {
  name: 'colaboradores',
  components:{
   AddClb,
       ...
       ...mapActions('colaborador', ['getAllInfoClb']),
         ...
         includesItem(search, name){
          ...
          return name.includes(search)
           ...
           changeView(option, item){
             this.item=item
             this.setAddedClb(item)
             this.setHistoryOptionClb(option)
         },
        ...
        eliminar: async function(){
            ...
            this.message='';
             ...
             let result = await this.$store.dispatch("colaborador/deleteItemClb", {option: 'colaborador', id:id});
