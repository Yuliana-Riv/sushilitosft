...
export default {
    ...
    actions:{
        setAddedOtr({commit}, payload){
            commit(SET_ADDED, payload);  
        },

        setHistoryOptionOtr({commit}, payload){
            commit(SET_HISTORY_OPTION, payload);  
        },
        async getAllInfoOtr({ commit }, payload) {
            commit(GETTING_INFO);
            commit(GETTING_MSG);
            //console.log(payload)
        ...
        async getInfoByIdOtr({ commit }, payload) {
            commit(GETTING_INFO);
            try {              
                let token = userService.getToken() 
                const _pk = ncryptService._createPubToken()
        ...
        async searchOtr({ commit }, payload) {
            commit(GETTING_INFO);
            commit(GETTING_MSG);
        ...
        async deleteItemOtr({ commit }, payload) { 
        ...
        async editItemOtr({ commit }, payload) { 
            commit(SET_STATUS, 'SUCCESS')
            try {               
                let token = userService.getToken() 
                const _pk = ncryptService._createPubToken()
        ...
        async addItemOtr({ commit }, payload) { 
            commit(SET_STATUS, 'SUCCESS')
