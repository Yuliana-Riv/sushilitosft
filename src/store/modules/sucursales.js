...
export default {
    ...
    actions:{
        setAddedSuc({commit}, payload){
            commit(SET_ADDED, payload);  
        },

        setHistoryOptionSuc({commit}, payload){
            commit(SET_HISTORY_OPTION, payload);  
        },
        async getAllInfoSuc({ commit }, payload) {
            commit(GETTING_INFO);
            commit(GETTING_MSG);
            //console.log(payload)
        ...
        async getInfoByIdSuc({ commit }, payload) {
            commit(GETTING_INFO);
            try {              
                let token = userService.getToken() 
                const _pk = ncryptService._createPubToken()
        ...
        async searchSuc({ commit }, payload) {
            commit(GETTING_INFO);
            commit(GETTING_MSG);
        ...
        async deleteItemSuc({ commit }, payload) { 
        ...
        async editItemSuc({ commit }, payload) { 
            commit(SET_STATUS, 'SUCCESS')
            try {               
                let token = userService.getToken() 
                const _pk = ncryptService._createPubToken()
        ...
        async addItemSuc({ commit }, payload) { 
            commit(SET_STATUS, 'SUCCESS')
