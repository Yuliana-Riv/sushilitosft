...
export default {
    ...
    actions:{
        setAddedenc({commit}, payload){
            commit(SET_ADDED, payload);  
        },

        setHistoryOptionenc({commit}, payload){
            commit(SET_HISTORY_OPTION, payload);  
        },
        async getAllInfoenc({ commit }, payload) {
            commit(GETTING_INFO);
            commit(GETTING_MSG);
            //console.log(payload)
        ...
        async getInfoByIdenc({ commit }, payload) {
            commit(GETTING_INFO);
            try {              
                let token = userService.getToken() 
                const _pk = ncryptService._createPubToken()
        ...
        async searchenc({ commit }, payload) {
            commit(GETTING_INFO);
            commit(GETTING_MSG);
        ...
        async deleteItemenc({ commit }, payload) { 
        ...
        async editItemenc({ commit }, payload) { 
            commit(SET_STATUS, 'SUCCESS')
            try {               
                let token = userService.getToken() 
                const _pk = ncryptService._createPubToken()
        ...
        async addItemenc({ commit }, payload) { 
            commit(SET_STATUS, 'SUCCESS')
