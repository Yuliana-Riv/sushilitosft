...
export default {
    ...
    actions:{
        setAddedBod({commit}, payload){
            commit(SET_ADDED, payload);  
        },

        setHistoryOptionBod({commit}, payload){
            commit(SET_HISTORY_OPTION, payload);  
        },
        async getAllInfoBod({ commit }, payload) {
            commit(GETTING_INFO);
            commit(GETTING_MSG);
            //console.log(payload)
        ...
        async getInfoByIdBod({ commit }, payload) {
            commit(GETTING_INFO);
            try {              
                let token = userService.getToken() 
                const _pk = ncryptService._createPubToken()
        ...
        async searchBod({ commit }, payload) {
            commit(GETTING_INFO);
            commit(GETTING_MSG);
        ...
        async deleteItemBod({ commit }, payload) { 
        ...
        async editItemBod({ commit }, payload) { 
            commit(SET_STATUS, 'SUCCESS')
            try {               
                let token = userService.getToken() 
                const _pk = ncryptService._createPubToken()
        ...
        async addItemBod({ commit }, payload) { 
            commit(SET_STATUS, 'SUCCESS')
